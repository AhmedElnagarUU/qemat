    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-20 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          ...
          <Link
            href="https://wa.me/0500401633"
            className="bg-transparent hover:bg-white/10 text-white border-2 border-white font-bold py-3 px-8 rounded-md transition-colors flex items-center gap-2"
          >
